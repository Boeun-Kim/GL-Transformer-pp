...
from model.transformer_cross_avg import ST_Transformer
from einops import rearrange, repeat
import os

class ActionRecognition(nn.Module):

    def __init__(self, num_frame, num_joint, num_p, input_channel, dim_emb,
                depth, num_heads, qkv_bias, ff_expand, do_rate, attn_do_rate,
                drop_path_rate, add_positional_emb, 
                num_action_class, positional_emb_type, cross_rolls):
        super(ActionRecognition, self).__init__()

        self.num_joint = num_joint
        self.transformer = ST_Transformer(num_frame, num_joint, num_p, input_channel, dim_emb,
                                            depth, num_heads, qkv_bias, ff_expand, do_rate, attn_do_rate,
    ...
    def load_transformer(self, file_path = "experiment/ST_pretrained_direction/epoch120"):
    ...
    def load_transformer_finetune(self, file_path = "experiment/ST_pretrained_direction/epoch120"):
